    ...
    return (
        <div className='flex'>
            ...
            <button onClick={openModal}
                className='flex items-center px-2 py-1 text-xs transition-all duration-75 ease-in-out bg-green-500 rounded-sm  w-fit hover:bg-green-400 hover:scale-105 hover:translate-y-0.5 active:bg-green-600 sm:text-sm md:text-lg'>
